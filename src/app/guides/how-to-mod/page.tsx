    ...
    <>
      ...
      <ContentPanel>
        ...
        <p className="mb-3 text-sm leading-relaxed text-muted-foreground">
          Start with Basics if you are new, then Elements and Weapons. Modular for Kitguns,
          Zaws, and Amps. Rivens and Arcanes when you are investing past the mod grid. Frames,
          companions, Archwing, mechs, and Railjack after that.
        </p>
