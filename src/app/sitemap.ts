...
const STATIC_ROUTES: Array<{
  ...
  { path: "/guides/how-to-mod/elements", changeFrequency: "monthly", priority: 0.65 },
  { path: "/guides/how-to-mod/weapons", changeFrequency: "monthly", priority: 0.65 },
  { path: "/guides/how-to-mod/modular", changeFrequency: "monthly", priority: 0.65 },
  { path: "/guides/how-to-mod/rivens", changeFrequency: "monthly", priority: 0.65 },
  { path: "/guides/how-to-mod/arcanes", changeFrequency: "monthly", priority: 0.65 },
  { path: "/guides/how-to-mod/warframes", changeFrequency: "monthly", priority: 0.65 },
  { path: "/guides/how-to-mod/companions", changeFrequency: "monthly", priority: 0.65 },
  { path: "/guides/how-to-mod/archwing", changeFrequency: "monthly", priority: 0.65 },
  { path: "/guides/how-to-mod/railjack", changeFrequency: "monthly", priority: 0.65 },
